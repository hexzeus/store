          ...
          <div className="container mx-auto px-6 py-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                ...
                <p className="text-[hsl(var(--muted-foreground))]">IVES_HUB MERCH brings you exclusive, luxury products that redefine style and comfort.</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold gold-gradient mb-4">Quick Links</h3>
                <ul className="space-y-2">
                  <li><Link href="/terms" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))] transition-colors duration-300">Terms of Service</Link></li>
                  <li><Link href="/privacy" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))] transition-colors duration-300">Privacy Policy</Link></li>
                  <li><Link href="/faq" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))] transition-colors duration-300">FAQ</Link></li>
                </ul>
              </div>
              <div>
                <h3 className="text-xl font-semibold gold-gradient mb-4">Connect With Us</h3>
                <div className="flex space-x-4">
                  <a href="#" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))] transition-colors duration-300">
